...
export class XpcString extends XpcObject {
    public static readonly xpc_string_get_string_ptr = new NativeFunction(
        Module.getExportByName(null, "xpc_string_get_string_ptr"), "pointer", ["pointer"]
    )

    public getRawData(): string {
        const str: string | null = XpcString.xpc_string_get_string_ptr(this.pointer).readCString();
        if (str == null)
