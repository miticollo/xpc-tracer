import { XpcString } from './xpc/string/xpcString'
import { XpcInt64 } from './xpc/number/XpcInt64'
import { XpcUint64 } from './xpc/number/xpcUint64'
import { XpcDouble } from './xpc/number/xpcDouble'
import { XpcBool } from './xpc/boolean/xpcBool'
import { XpcDictionary } from './xpc/dictionary/xpcDictionary'
import { XpcData } from './xpc/data/xpcData'
import {XpcNull} from "./xpc/null/xpcNull";
import {XpcDate} from "./xpc/date/xpcDate";
import {XpcFd} from "./xpc/fd/xpcFd";
import {XpcArray} from "./xpc/array/xpcArray";
import {XpcUnknown} from "./xpc/xpcUnknown";
import {XpcMachSend} from "./xpc/mach/xpcMachSend";
import {XpcEndpoint} from "./xpc/endpoint/xpcEndpoint";
...
function hook(functionName: string) {
